...
<div class="block block-rounded mx-5">
    <div class="block-header block-header-default">
        ...
        <div class="">
            <a href="/dashboard/role/create" class="btn btn-success ml-2 leading-2 px-3">+ Role</a>
        </div>
    </div>
    <div class="block-content block-content-full">
        ...
        <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
            <thead>
                <tr>
                    <th class="d-none d-sm-table-cell">Nama Role</th>
                    <th class="d-none d-sm-table-cell" style="width: 60%;">Permissions</th>
                ...
                @foreach ($role as $r)
                    <tr>
                        ...
                        <td class="fw-semibold">
                            @foreach ($r->permissions as $i)
                                <span class="badge bg-success">{{ $i->name }}</span>
                            @endforeach

                        </td>
                        <td class="text-center">
                            <a href="/dashboard/role/edit/{{ $r->name }}" aria-hidden="true"
                                class="custom-button"
                            ...
                            <a onclick="deleteConfirmation({{ $r->id }})" aria-hidden="true"
                                class="custom-button"
    ...
    function deleteConfirmation(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = "/dashboard/role/delete-role/" + id;
            }
        })
    }
</script>
