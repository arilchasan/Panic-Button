...
<head>
    ...
    <meta name="author" content="ArilChasan">
    ...
    <!-- Icons -->
    <link rel="shortcut icon" href="{{ asset('assets/p_icon.png') }}">
    <link rel="icon" sizes="192x192" type="image/png" href="{{ asset('assets/p_icon.png') }}">
    ...
    <div id="page-container" class="sidebar-o enable-page-overlay side-scroll page-header-modern main-content-boxed">
        ...
        <aside id="side-overlay">
            ...
            <div class="content-header">
                ...
                <!-- User Info -->
                <a class="link-fx text-body-color-dark fw-semibold fs-sm">
                    John Smith
                </a>
                <!-- END User Info -->
                    ...
                    <div>
                        ...
                        <a class="link-fx fw-bold tracking-wide mx-auto" href="/">
                            <span class="smini-hidden">
                                {{-- <i class="fa-brands fa-pinterest-p fa-lg text-primary"></i> --}}
                                <span class="fs-4 text-primary">Panic</span><span class="fs-4 text-dual">Button</span>
                            </span>
                        </a>
                    </div>
                    <!-- END Logo -->
                ...
                <div class="js-sidebar-scroll">
                            ...
                            <ul class="list-inline mt-3 mb-0">
                                <li class="list-inline-item">
                                    <a class="link-fx text-dual fs-sm fw-semibold text-uppercase"
                                        href="javascript:void(0)">{{ auth('admin')->user()->name }}</a>
                                </li>

                                <li class="list-inline-item">
                                    <a class="link-fx text-dual" href="/auth/logout">
                    ...
                    <div class="content-side content-side-full">
                        <ul class="nav-main">
                            ...
                            <li class="nav-main-item{{ request()->is('dashboard/permission/all', 'dashboard/role/all', 'dashboard/admin/all') ? ' open' : '' }}">
                                <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu"
                                    aria-haspopup="true" aria-expanded="true" href="#">
                                    <i class="nav-main-link-icon fa fa-users" aria-hidden="true"></i>
                                    <span class="nav-main-link-name">Admin Menu</span>
                                </a>
                                <ul class="nav-main-submenu">
                                    <li class="nav-main-item">
                                        <a class="nav-main-link{{ request()->is('dashboard/permission/all') ? ' active' : '' }}"
                                            href="/dashboard/permission/all">
                                            <i class="nav-main-link-icon fa-regular fa-circle-dot"></i>
                                            <span class="nav-main-link-name">Permissions</span>
                                        </a>
                                    </li>
                                    <li class="nav-main-item">
                                        <a class="nav-main-link{{ request()->is('dashboard/role/all') ? ' active' : '' }}"
                                            href="/dashboard/role/all">
                                            <i class="nav-main-link-icon fa-regular fa-circle-dot"></i>
                                            <span class="nav-main-link-name">Role</span>
                                        </a>
                                    </li>
                                    <li class="nav-main-item">
                                        <a class="nav-main-link{{ request()->is('dashboard/admin/all') ? ' active' : '' }}"
                            ...
                            <li class="nav-main-item">
                                <a class="nav-main-link{{ request()->is('dashboard/user/all') ? ' active' : '' }}"
                            ...
                            <li class="nav-main-item">
                                <a class="nav-main-link{{ request()->is('dashboard/subscriptions/index') ? ' active' : '' }}"
                                    href="/dashboard/subscriptions/index">
                                    <i class="nav-main-link-icon fa-regular fa-clipboard"></i>
                                    <span class="nav-main-link-name">Subscriptions</span>
                                </a>
                            </li>
                            <li class="nav-main-item">
                                <a class="nav-main-link{{ request()->is('dashboard/information/all') ? ' active' : '' }}"
                                    href="/dashboard/information/all">
                                    <i class="nav-main-link-icon fa-solid fa-file"></i>
                                    <span class="nav-main-link-name">Information</span>
                                </a>
                            </li>
                            <li class="nav-main-item">
                                <a class="nav-main-link{{ request()->is('dashboard/contact/all') ? ' active' : '' }}"
                                    href="/dashboard/contact/all">
            ...
            <div class="content py-3">
                <div class="row fs-sm">
                    ...
                    <div class="col-sm-6 order-sm-1 py-1 text-center text-sm-start">
                        <a class="fw-semibold" href="https://1.envato.market/95j" target="_blank">Panic Button</a>
